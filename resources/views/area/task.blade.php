        ...
        <div class="card-header">
            ...
            <div class="card-header-action">
                @if (Auth::user()->role == 'Admin')
                    <button class="btn btn-primary btn-lg mb-1" data-toggle="modal" data-target="#modal_add"><i
                            class="fas fa-plus"></i> Tambah</button>
                @endif
                <button type="button" onclick="exportTask()" class="btn btn-success btn-lg ml-1 mb-1"><i
                        class="fas fa-download"></i> Export Excel</button>
            </div>

        </div>
        <div class="card-body">
            <button class="btn btn-primary mb-2 d-lg-none" type="button" data-toggle="collapse"
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select name="worker_id" id="worker_id_add" class="form-control">
                                        <option selected disabled>- Pilih Worker -</option>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="form_edit_pay">
                        ...
                        <button type="submmit" id="btn_edit_pay" class="btn btn-primary m-t-15 waves-effect">Submit
                            Pengajuan</button>
                    </form>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="form_edit_status">
                        ...
                        <button type="submmit" id="btn_edit_status"
...
@push('js')
    <script>
        ...
        var url_datatable = '{{ url('task/list') }}' + '?tanggal_mulai_filter=' + tanggal_mulai + '&tanggal_akhir_filter=' +
            tanggal_akhir + '&task_status_filter=' + task_status + '&pay_status_filter=' + pay_status;
                ...
                @endif {
                    ...
                    "render": function(data, type, row, meta) {
                        ...
                        @if (Auth::user()->role == 'Admin')
                            ...
                            html += '<a href="' + url_detail +
                                '" class="btn btn-icon btn-sm btn-info mr-1"><i class="fas fa-file-alt" style="width: 16px"></i></a>';
                            html += '<a href="javascript:;" onclick="editData(\'' + row.id +
                                '\')" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit Data" class="btn btn-icon btn-sm btn-warning mr-1"><i class="fas fa-edit" style="width: 16px"></i></a>';
                            html += '<a href="javascript:;" onclick="deleteData(\'' + row.id +
                                '\')" class="btn btn-icon btn-sm btn-danger mr"><i class="fas fa-trash" style="width: 16px"></i></a>';
                            html += '</div>';
                        @else
                            html = '<div class="text-nowrap">';
                            if (row.task_status == 'Waiting') {
                                html += '<a href="javascript:;" onclick="editPay(\'' + row.id +
                                    '\')" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit Data" class="btn btn-icon btn-sm btn-info mr-1"><i class="fas fa-money-check" style="width: 16px"></i></a>';
                            }
                            html += '<a href="' + url_detail +
                                '" data-toggle="tooltip" data-placement="top" title="" data-original-title="Detail Data" class="btn btn-icon btn-sm btn-warning mr-1"><i class="fas fa-edit" style="width: 16px"></i></a>';
                            html += '<a href="javascript:;" onclick="editStatus(\'' + row.id + '\',\'' + row
                                .task_status +
                                '\')" class="btn btn-icon btn-sm btn-success"><i class="fas fa-check" style="width: 16px"></i></a>';
                            html += '</div>';
                        @endif
        ...
        function reloadDataTable() {
            ...
            var newUrl = currentUrl + '?tanggal_mulai_filter=' + tanggal_mulai + '&tanggal_akhir_filter=' + tanggal_akhir +
                '&task_status_filter=' + task_status + '&pay_status_filter=' + pay_status;
            if ('{{ Auth::user()->role }}' == "Worker") {
        ...
        function exportTask() {
            ...
            url += '?search_filter=' + search + '&tanggal_mulai_filter=' + tanggal_mulai + '&tanggal_akhir_filter=' +
                tanggal_akhir + '&task_status_filter=' + task_status + '&pay_status_filter=' + pay_status;
